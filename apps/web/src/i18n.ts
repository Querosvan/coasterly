...
export const messages = {
  en: {
    ...
    ride: {
      ...
      signInToTrack: "Sign in to save this credit to your profile.",
      creditSavedSuccess: "Credit saved. Your progress and profile were updated.",
      creditRemovedSuccess: "Credit removed. Your progress and profile were updated.",
      queueTimes: "Queue-Times",
  ...
  es: {
    ...
    ride: {
      ...
      signInToTrack: "Inicia sesión para guardar este crédito en tu perfil.",
      creditSavedSuccess: "Crédito guardado. Tu progreso y perfil se han actualizado.",
      creditRemovedSuccess: "Crédito quitado. Tu progreso y perfil se han actualizado.",
      queueTimes: "Queue-Times",
