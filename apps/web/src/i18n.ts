...
export const messages = {
  en: {
    ...
    profile: {
      ...
      emptyStateLabel: "Get started",
      emptyStateTitle: "Start building your coaster history.",
      emptyStateBody:
        "Log your first rides to track credits, build park progress, and turn this into a public profile worth sharing.",
      emptyStateValueCredits: "Track coaster credits",
      emptyStateValueParks: "Build park progress",
      emptyStateValuePublic: "Create a public profile",
      emptyStateBrowseParks: "Browse parks",
      emptyStateBrowseRides: "Browse rides",
